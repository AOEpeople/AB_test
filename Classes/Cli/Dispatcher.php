...
class Dispatcher
{
    ...
    /**
     * Init logger and set desired log level derived from given parameter --log-level
     */
    ...
    /**
     * Gather action's name and return it
     * @return string
     */
    protected function getControllerAction()
    {
        $action = (isset($this->arguments['a']) && strlen($this->arguments['a']) > 0) ? $this->arguments['a'] : 'default';
        $action .= 'Action';
    ...
    /**
     * Message output to describe usage of AB testing call
     */
